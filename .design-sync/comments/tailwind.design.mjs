/**
 * Tailwind config for the comment-overlay design bundle. Mirrors the pagepin
 * console theme (so the sample page + concepts share the brand language) and scans
 * the console source + the comment design sources.
...
export default {
  ...
  theme: {
    extend: {
      colors: {
        tide: { 50: '#e6f4f2', 100: '#cfe9e5', 200: '#bfe5df', 300: '#8fd3ca', 400: '#3dafa4', 500: '#14958a', 600: '#0f7c72', 700: '#0b6358', 800: '#0b5a53', 900: '#08433d', 950: '#06302c' },
        ink: { 50: '#fafafa', 100: '#f4f5f6', 200: '#e7e9eb', 300: '#d7dadd', 400: '#9aa1a9', 500: '#8a929b', 600: '#6b7480', 700: '#3a424b', 800: '#1b2127', 900: '#11161b' },
      },
      fontFamily: {
