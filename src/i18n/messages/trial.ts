...
export const trial: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'trial.file.missing': 'Provide a single HTML file in the "file" field',
    'trial.file.notHtml': 'Trial accepts a single .html file',
  ...
  zh: {
    ...
    'trial.file.missing': '请在 file 字段提供一个 HTML 文件',
    'trial.file.notHtml': '试用仅接受单个 .html 文件',
